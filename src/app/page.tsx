...
export default function TopBar() {
  ...
  <div className=" mt-7 flex border border-[#9CA3AF] ">
      ...
      <div className="flex gap-6 mt-6 mb-22">
        <div className="">
          <div className="w-48  ">
      ...
      <div className="flex items-center justify-center mt-24 flex-col text-[#414141] ">
        <div className="flex gap-3 items-center">
          <p className="text-3xl text-[#6B7280]">
            BEST <span className="text-[#374051] font-medium">SELLERS</span>
          </p>
          <p className="w-12 h-[2px] bg-[#414141]"></p>
        </div>
      ...
      <div className="flex justify-between mt-28">
        <div className="">
          <div className="text-md mt-3 flex items-center flex-col">
            <div className="w-12 mb-4 flex items-center justify-center ">
            ...
            <p className="mb- text-[#374051] font-bold">Easy Exchange Policy</p>
        ...
        <div className="">
          <div className="text-md mt-3 flex items-center flex-col">
            ...
            <p className="mb- text-[#374051] font-bold">7 Days Return Policy</p>
            <span className="text-[#9CA3AF]">
        ...
        <div className="">
          <div className="text-md mt-3 flex items-center flex-col">
            ...
            <p className="mb- text-[#374051] font-bold">
        ...
        <div className="flex w-full bg-[#F9FAFB] ">
          ...
          <div className="w-[80%] pl-18 p-8">
            ...
            {/* <div className="flex gap-3 items-center">
                <p className="text-2xl text-[#6B7280] mt-8">
                  DELIVERY{" "}
                  <span className="text-[#374051] font-medium">
                    INFORMATION
                  </span>
                </p>
                <p className="w-12 h-[2px] bg-[#414141] mt-8"></p>
            ...
            <div className="  mt-4 flex gap-4  border">
              ...
              <div className="  mt-4 w-[39%] text-sm">
              ...
              <div className="  mt-4 w-[17%]">
                <select className="border rounded outline- p-2">
